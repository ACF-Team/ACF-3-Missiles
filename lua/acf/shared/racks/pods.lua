...
ACF.RegisterRack("57mm32xPOD", {
	...
	MountPoints = {
		...
		{ Name = "missile24", Position = Vector(-8,1.90,-10.7) },
		{ Name = "missile25", Position = Vector(-8,-1.90,-10.7) },
...
ACF.RegisterRack("70mm19xPOD", {
	...
	MountPoints = {
		{ Name = "missile1", Position = Vector(5,-3.9,7.0) },
		{ Name = "missile2", Position = Vector(5,0,7.0) },
		{ Name = "missile3", Position = Vector(5,3.9,7.0) },
		...
		{ Name = "missile8", Position = Vector(5,-8.0,0) },
		{ Name = "missile9", Position = Vector(5,-4.0,0) },
		{ Name = "missile10", Position = Vector(5,0,0) },
		{ Name = "missile11", Position = Vector(5,4.0,0) },
		{ Name = "missile12", Position = Vector(5,8.0,0) },
