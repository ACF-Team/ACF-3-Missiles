ACF.RegisterComponentClass("GD-CPR", {
...
do -- Joystick
	...
	ACF.RegisterComponent("CPR-Joystick", "GD-CPR", {
		Name		= "Joystick",
...
do -- Optical guidance computer
	...
	hook.Add("OnMissileLaunched", "ACF Optical Computer Filter", function(Missile)
		for Computer in pairs(Computers) do
			local Index = #Computer.Filter + 1

			Computer.Filter[Index] = Missile
		end
	end)
...
do -- Laser guidance computer
	...
	ACF.RegisterComponent("CPR-LSR", "GD-CPR", {
