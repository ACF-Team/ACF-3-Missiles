...
net.Receive( "acfm_versionresponse", function()
	...
	if not inDate then
		...
		chat.AddText(Color(255,0,0), "Update this server to the latest version at ", Color(255, 128, 0), "https://github.com/TwistedTail/ACF-3-Missiles")
	else
