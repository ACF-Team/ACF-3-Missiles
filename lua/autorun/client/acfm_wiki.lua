...
local function wikiPagesFailed(callback)
	print('Failed to load the ACF Missiles Wiki.  If this continues, please inform us at https://github.com/TwistedTail/ACF-3-Missiles')
	callback()
end
...
function Menu.MakePanel(Panel)
	...
	if not CPanel then CPanel = Panel end
